...
function LoadForms() {
    var signupForms = $("div.signup-form");

    signupForms.each(function(i, form) {
        var target = $(form);
        var plans = [
            "Essential",
            "Professional",
        ...
        var types = plans.join("</option><option>")


        var f = $("<form method='POST' action='/api/join' />"),
        ...
        f.append("<h2>Join</h2><hr><p>Fill out the form below to try StoreHub for 1 month.</p>")

        f.append(name);
        f.append(email)
        f.append(accountType)
        f.append(passwordActual)
...
$(document).ready(function() {
    ...
    if (signupForms.length > 0) {
        ...
        LoadScript("/js/form.js", LoadForms);
    }
